    ...
    <div className="layout">
      ...
      <header className="app-header">
        ...
        <div className="app-logo">
          ...
          <div>
            <h1>AcuiCal <span style={{fontSize:10,fontWeight:400,color:"var(--text2)"}}>v0.1</span></h1>
      ...
      <aside className={`sidebar${sidebarOpen ? " open" : ""}`}>
        <div className="sidebar-header">
          ...
          <span className="sidebar-title">AcuiCal <span style={{fontSize:10,fontWeight:400,color:"var(--text2)"}}>v0.1</span></span>
