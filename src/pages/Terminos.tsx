  ...
  return (
    <div style={{ maxWidth: 720, margin: "0 auto", padding: "20px 0" }}>
      ...
      <Section title="4. Planes y Suscripciones">
        ...
        <p><strong>4.4. Facturación</strong> — Pagos via Stripe. Renovación automática. Cancelación desde el panel.</p>
      ...
      <Section title="6. Privacidad y Protección de Datos">
        ...
        6.2. Los datos de pago son procesados exclusivamente por Stripe.<br />
      ...
      <Section title="12. Contacto">
        Correo: <a href="mailto:terminos@acucal.com">terminos@acucal.com</a><br />
